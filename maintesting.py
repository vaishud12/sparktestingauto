...
wd = webdriver.Edge(executable_path="C:\\Users\\User1\\Downloads\\msedgedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Vaishnavi devardekar')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('vaishuu2397@gmail.com')
    time.sleep(3)
